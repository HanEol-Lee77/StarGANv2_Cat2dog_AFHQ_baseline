...
def calculate_fid_given_paths(paths, img_size=256, batch_size=50):
    ...
    # set_trace()
    print(f'img_size:{img_size}, batch_size:{batch_size}  paths: {paths} ')
    loaders = [get_eval_loader(path, img_size, batch_size) for path in paths] # img_size: 256,  batch_size: 32,  path: 
